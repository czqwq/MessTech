...
public class NanoScaleFoundry24PoolFrontend extends RecipeMapFrontend {
     ...
     * 3 Supercomputer, 4 Mainframe) first, and finally the special Pico/Quantum/Planck chains, which need no selector
     * at all. Within one level the output name decides, so the list is stable.
     */
