...
public class MTReactorHeatHatch extends MTEHatch {
    ...
    /**
     * Icon path relative to {@code textures/blocks}. It is handed to {@code Textures.BlockIcons.custom} together with
     * the domain, that API takes a single {@code [modid:]path} name.
     */
