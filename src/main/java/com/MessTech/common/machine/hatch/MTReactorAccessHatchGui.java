...
public class MTReactorAccessHatchGui extends MTEHatchBaseGui<MTReactorAccessHatch> {
    ...
    private static final IDrawable SMALL_LOCK_ICON = new IDrawable() {
        ...
        public void draw(GuiContext context, int x, int y, int width, int height, WidgetTheme widgetTheme) {
            ...
            GTGuiTextures.OVERLAY_BUTTON_LOCKED.draw(context, x + width - size, y, size, size, widgetTheme);
        }
    };
    ...
    protected Widget<?> makeLogoWidget() {
        return new IDrawable.DrawableWidget(MTGuiTextures.PICTURE_MT_LOGO).size(SLOT_SIZE);
    }
}
